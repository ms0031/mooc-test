...
export default function TestSettingsPage() {
  ...
  return (
    <div className=" bg-slate-950 h-screen flex items-center justify-center ">
      <div className="mt-4 mb-16 max-w-md mx-5 bg-white/1 rounded-3xl outline-2 outline-offset-[-1px] outline-white/5 backdrop-blur-[100px] overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              id="timer-toggle"
              disabled={studyMode}
              className={`${enableTimer ? "bg-teal-500/90" : "bg-gray-500"} ${
