          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="flex-1 w-full mb-8">
              <div className="text-center lg:text-left">
                <h2 className="text-2xl md:text-3xl leading-tight font-bold text-gray-200">
                  🙋‍♂️ About Me
                </h2>
                <h1 className="text-4xl md:text-6xl lg:text-7xl leading-tight font-bold text-gray-200 mt-4">
                  I'm <br className="hidden lg:block" /> Mayank Shekhar
                </h1>
                <p className="text-xl md:text-2xl leading-[32px] md:leading-[40px] font-medium mt-3 text-gray-400 max-w-2xl mx-auto lg:mx-0">
                  A passionate web developer and CS undergrad who loves building
                  useful tools for learners.
                </p>
              </div>
              <div className="text-center lg:text-left mt-8">
                <p className="text-2xl md:text-4xl leading-[40px] font-medium text-gray-500 mb-6">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                      viewBox="0 0 30 30"
                      id="Linkedin-Logo--Streamline-Logos-Block"
                      height="40"
                      width="40"
                    >
                      ...
                      <path
                        fill="#edf2f7"
                        fillRule="evenodd"
                        d="M6.25 1.25a5 5 0 0 0 -5 5v17.5a5 5 0 0 0 5 5h17.5a5 5 0 0 0 5 -5V6.25a5 5 0 0 0 -5 -5H6.25Zm1.50625 8.6375a2.13125 2.13125 0 1 0 0 -4.2625 2.13125 2.13125 0 0 0 0 4.2625ZM9.88625 24.375V11.591249999999999H5.625V24.375h4.2625Zm5.540000000000001 -12.783750000000001H11.591249999999999V24.375h3.835v-7.7125c0.49375 -0.8025 1.34625 -1.6625 2.55625 -1.6625 1.705 0 2.13125 1.705 2.13125 2.5574999999999997V24.375H24.375v-6.8175c0 -2.285 -0.9962500000000001 -5.96625 -4.6875 -5.96625 -2.3474999999999997 0 -3.65 0.8562500000000001 -4.2625 1.65875V11.591249999999999Z"
                        clipRule="evenodd"
                        strokeWidth="1.25"
                      ></path>
                    </svg>
