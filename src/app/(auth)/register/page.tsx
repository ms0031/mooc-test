...
export default function RegisterPage() {
  ...
  return (
    <div className="w-full h-screen relative bg-slate-950 overflow-hidden flex items-center justify-center">
      ...
      <div className="max-w-md lg:w-full md:w-full w-100 lg:px-10 md:px-10 px-6 pb-10 pt-4 gap-4 bg-white/0 rounded-3xl outline-2 outline-offset-[-1px] outline-white/5 backdrop-blur-[100px] overflow-hidden">
