  ...
  return (
    <>
      ...
      <button
        ...
        className={`bg-white/10 border border-white/15 backdrop-blur-sm rounded-full p-2 transition-colors duration-300 ${
          isBookmarked ? "text-yellow-400 hover:text-yellow-500" : "text-gray-400 hover:text-yellow-300"
